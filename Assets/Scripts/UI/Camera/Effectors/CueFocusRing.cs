...
public sealed class CueFocusRing : CueFocusBase
{
  ...
  {
    var distanceToEffector = Vector3.Distance(EffectorPosition, this.trackedTarget.position);
    ...
    if (this.enableEffectorFalloff)
      return this.effectorFalloff.Evaluate(1f - (distanceToEffector / OuterRingRadius)) * this.effectorWeight;

    return this.effectorWeight;
  }
}
