        ...
        public static Configuration Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    Configuration configuration = AssetDatabase.LoadAssetAtPath("Assets/Plugins/MarkUX/Configuration/Configuration.asset", typeof(Configuration)) as Configuration;
                    if (configuration == null)
                    {
                        // create new asset                        
                        System.IO.Directory.CreateDirectory("Assets/Plugins/MarkUX/Configuration/");
                        configuration = ScriptableObject.CreateInstance<Configuration>();
                        AssetDatabase.CreateAsset(configuration, "Assets/Plugins/MarkUX/Configuration/Configuration.asset");
