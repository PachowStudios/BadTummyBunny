    ...
    public class Configuration : ScriptableObject
    {
        ...
        public static Configuration Instance
        {
            get
            {
                ...
                Configuration configuration = AssetDatabase.LoadAssetAtPath("Assets/Resources/MarkLight.asset", typeof(Configuration)) as Configuration;
                ...
                var configFilePath = System.IO.Directory.GetFiles(Application.dataPath, "MarkLight.asset", System.IO.SearchOption.AllDirectories).FirstOrDefault();
                ...
                AssetDatabase.CreateAsset(configuration, "Assets/Resources/MarkLight.asset");
